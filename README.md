...
- Customization options for scripts
...
XCutors is a collection of Roblox executors and a script loader for Windows.

### Is it safe to use?

XCutors is designed with safety in mind, but always use it responsibly and at your own risk.
...
Check the GitHub repository for updates or use the built-in update feature if available.

### Can I use it on macOS?

No, XCutors is specifically for Windows desktop.

### Do I need to install Lua?

No, the executors handle Lua execution internally.

### What should I do if an executor doesn't work?

Try running as administrator, disable anticomponent temporarily, or check for updates.
